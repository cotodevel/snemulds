...
extern int initSNESEmpty(bool * firstTime, u32 inApuCacheSamples, bool inApuCacheSamplesTWLMode, u32 * inSavedROMForAPUCache);
extern int OldPC;
extern int go();
...
extern bool	changeROM(char *ROM, int size);
