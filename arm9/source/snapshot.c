...
int		get_snapshot_name(char *file, uchar nb, char *name){
	...
	TSnapShot_Header *header = (TSnapShot_Header *)TGDSARM9Malloc(sizeof(TSnapShot_Header));
...
bool	read_snapshot(char *file, uchar nb){
	...
	TSnapShot *snapshot = (TSnapShot *)TGDSARM9Malloc(sizeof(TSnapShot));
