...
#define ROM_MAX_SIZE_NTRMODE_LOROM_PAGEMODE	((int)(1*1024*1024))			//LoROM streaming
...
#define getCX4_CACHE_ADDRESS(ptr) ((int)ptr + ROM_MAX_SIZE_NTRMODE_LOROM_PAGEMODE - (CX4_PAGING_SLOTS * PAGE_HIROM))
