...
dsp: DSP games-only branch. Plays DSP-only games! There are some sprite issues, and speed is a bit slower, but hey these play!
...
TWL Mode:
	-DSP games plays at 60fps on TWL hardware (DSi/3DS). If you can, use SnemulDS TWL instead.
